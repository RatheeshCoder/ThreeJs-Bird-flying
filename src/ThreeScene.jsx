...
const ScrollAnimationComponent = () => {
  ...
  useEffect(() => {
    ...
    loader.load('/src/assets/Flamingo.glb', (gltf) => {
      ...
      setObservers([firstObserver, secondObserver, thirdObserver, fourthObserver]);
  ...
  return (
    <>
      ...
      <div className="main">
        <section className="demo" id="first">
         <Header/>
        </section>
        <div className="demo" id="second">
         <Section2/>
        </div>
        <div className="demo" id="third">
          <Section3/>
        </div>
        <div className="demo" id="fourth">
          <Section4/>
        </div>
      </div>
    </>
